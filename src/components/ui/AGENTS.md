...
- `CodeBlock` continua sendo server component para rendering com Shiki.
- Para input editável de código, crie um `CodeEditor` client component separado em vez de tornar `CodeBlock` interativo.
